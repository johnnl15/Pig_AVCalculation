...
y <- read_excel("../Datafiles//HF_Official_Data.xlsx",sheet = "log2VA")
y <- y %>%
...
zmelt <- zmelt %>%
  ...
  mutate(time=ifelse(time == "000m",0,
                     ifelse(time == "030m",30,
                            ifelse(time == "060m",60,
                                   ifelse(time == "120m",120,time))))) %>%
  mutate(time = as.numeric(time))

unique(zmelt$organ)
unique(zmelt$time)
###############Now we will conduct One-Sample Test
...
write.csv(stats.test.onesample.median,file="../Datafiles/Statistics/1_OneSample_HF.csv",row.names = FALSE)
...
write.csv(stats.test.onesample.Group.median.perorganFDR,file="../Datafiles/Statistics/1_OneSample_PerOrgan_HF.csv",row.names = FALSE)
...
write.csv(stats.test.onesample.median,file="../Datafiles/Statistics/1.1_OneSample_HF_AllMetabolites.csv",row.names = FALSE)
...
write.csv(stats.test.onesample.Group.median.perorganFDR2,file="../Datafiles/Statistics/2_OneSample_PerOrganFDR_HF.csv",row.names = FALSE)

###############Now we will conduct ANOVAS per compound, per organ, compared across time
#first create needed columns for ANOVA

zmelt2<-zmelt %>% group_by(Compound,organ) %>% 
  #summarise(Total = n()) %>%
  filter(n()>5)
...
write.csv(stats.test.anova.median,file="../Datafiles/Statistics/3_ANOVA_TimeComparison_HF.csv",row.names = FALSE)
...
write.csv(stats.test.anova.median.perorganFDR,file="../Datafiles/Statistics/4_ANOVA_TimeComparison_FDRPerOrgan_HF.csv",row.names = FALSE)
...
write.csv(stats.test.anova.median,file="../Datafiles/Statistics/3_2_ANOVA_OrganComparison_HF.csv",row.names = FALSE)
...
write.csv(stats.test.anova.median,file="../Datafiles/Statistics/3_2_ANOVA_OrganPlusTimeComparison_HF.csv",row.names = FALSE)
...
write.csv(stats.test.anova.median2,file="../Datafiles/Statistics/4_2_ANOVA_OrganTime_HF.csv",row.names = FALSE)
...
write.csv(stats.test.t.fastvsfed.median,file="../Datafiles/Statistics/5_TTest_FastvsFed_HF.csv",row.names = FALSE)
...
write.csv(stats.test.t.fastvsfed.median.perorganFDR,file="../Datafiles/Statistics/6_TTest_FastvsFed_PerOrganFDR_HF.csv",row.names = FALSE)
...
write.csv(stats.test.t.fastvsfed.median,file="../Datafiles/Statistics/5_2_TTest_0minvs3060120min_HF.csv",row.names = FALSE)
...
for (i in 1:length(organtypes)){
  ...
  stats.test.t.fastvsfed.median.each<-zmelt2organ %>% 
    ...
    adjust_pvalue(method = "fdr") %>%
    add_significance("p.adj")
  #stats.test.t.fastvsfed.median.each$organ = organtypes[i]
  stats.test.t.fastvsfed.median.perorganFDR<-rbind(stats.test.t.fastvsfed.median.perorganFDR,stats.test.t.fastvsfed.median.each)
}
...
write.csv(stats.test.t.fastvsfed.median.perorganFDR,file="../Datafiles/Statistics/6_2_TTest_0minvs3060120min_PerOrganFDR_HF.csv",row.names = FALSE)
write.csv(stats.test.t.fastvsfed.median.perorganFDR_absfoldchange,file="../Datafiles/Statistics/6_2_TTest_0minvs3060120min_FoldChangeAbsolute_PerOrganFDR_HF.csv",row.names = FALSE)
...
write.csv(stats.test.onesample.GroupTime.median,file="../Datafiles/Statistics/7_OneSample_GroupTime_HF.csv",row.names = FALSE)
...
write.csv(stats.test.onesample.GroupTime.median.perorganFDR,file="../Datafiles/Statistics/8_OneSample_GroupTime_PerOrganFDR_HF2.csv",row.names = FALSE)
